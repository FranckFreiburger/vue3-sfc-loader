...
:warning: **beware**, the following examples are sticky to version *<!--version-->0.4.5<!--/version-->*. For your use, prefer the [latest version](../README.md#dist)
...
<body>
  ...
  <script src="https://cdn.jsdelivr.net/npm/vue3-sfc-loader@0.4.5/dist/vue3-sfc-loader.js"></script>
  <script>
